...
Hence, using Fubini-Tonelli theorem and the first order moment of the dirichlet distribution (WARNING: this is incorrect, we can actually compute the integrales directly), we get for all $k \geq 2$:
$$
